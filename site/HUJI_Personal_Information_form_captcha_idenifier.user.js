...
// @include        https://www.huji.ac.il/dataj/controller/*/stu/STU-SITEMAP* 
// @require        https://code.jquery.com/jquery-2.0.3.min.js
// @grant          GM_xmlhttpRequest
// @updateURL      http://www.cs.huji.ac.il/~omershe/captcha/HUJI_Personal_Information_form_captcha_idenifier.meta.js
// @downloadURL    http://www.cs.huji.ac.il/~omershe/captcha/HUJI_Personal_Information_form_captcha_idenifier.user.js
// @run-at         document-end
// ==/UserScript==

var ECRYPTED_SERVER = [104, 116, 116, 112, 58, 47, 47, 119, 119, 119, 46, 99, 115, 46, 104, 117, 106, 105, 46, 97, 99, 46, 105, 108, 47, 126, 111, 109, 101, 114, 115, 104, 101, 47, 99, 97, 112, 116, 99, 104, 97, 47, 99, 97, 112, 116, 99, 104, 97, 46, 112, 104, 112];
var server = "";
...
retry.css( {
	...
	"cursor": "pointer"
	}).attr("id", "retry").click(unsafeWindow.retryCaptcha).html("נסה שנית");
